...
class StateTable {
friend FSM; // INPUTS
protected:  /* INTEGER,   REAL,   OPERATOR,   
...
// Is current state starting state? (Did you just arrive 
on a new lexeme?)
{
// Only add tokens and lexemes that are not 
SPACE or COMMENT to container.
{
}
// If previous state is COMMENT. We move the 
expression index forward.
// Reset lexeme string.
}
